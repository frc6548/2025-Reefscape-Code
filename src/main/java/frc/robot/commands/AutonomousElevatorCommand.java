...
// public class AutonomousElevatorCommand extends Command {
...
//     public AutonomousElevatorCommand(Elevator elevatorSubsystem, double setpoint) {
...
//         double error = elevatorSubsystem.getElevatorEncoder1() - pidController.getSetpoint();
//         return (Math.abs(error) < .4);
//       }

//   @Override
//   public void initialize() {
//     System.out.println("AutonomousElevatorCommand started!");
...
//     elevatorSubsystem.setElevatorMotor(0);
//     System.out.println("AutonomousElevatorCommand ended!");
//   }
