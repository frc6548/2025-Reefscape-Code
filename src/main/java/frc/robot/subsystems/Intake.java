...
public class Intake extends SubsystemBase{
    ...
    public double positionalTolerance = 2; //if the encoder is less than this distance (1 revolution) it is considered at the setpoint. this is used by the intake commands.
